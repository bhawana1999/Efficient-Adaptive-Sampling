...
parser.add_argument(
    "--osp", help="On the way sampling parameter", default=0.25, type=float)
parser.add_argument("--init_rad", help="initial radius", default=10, type=int)
...
env = environment()
agent = DP_agent(env=env, beta=args.beta, n_samples=args.n, directory=directory, osp=args.osp,
                 init_radius=args.init_rad)
